...
namespace TelephoneDiary
{
    public partial class Phone : Form
    {
        ...
        SqlConnection con = new SqlConnection("Data Source=DESKTOP-6AFGT2T;Initial Catalog=Phone;Integrated Security=True");
        public Phone()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand(@"INSERT INTO Mobiles 
                (First, Last, Mobile, Email, Category) VALUES ('"+textBox1.Text+ "', '" + textBox2.Text + "', '" + textBox3.Text + "', '" + textBox4.Text + "', '" + comboBox1.Text + "')", con);
            cmd.ExecuteNonQuery();
        ...
        private void Phone_MouseClick(object sender, MouseEventArgs e)
        {
